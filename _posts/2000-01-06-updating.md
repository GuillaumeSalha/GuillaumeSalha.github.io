...
The difference in standard deviation of the distributions of predicted scores between both seems negligible: 14.08 (with genres) vs 14.63 (without). A  test gives a small difference in their average values. 
